...
//1. 산술 연산자
// - 산술 연산자의 피 연산자는 모두 숫자(number) 이여야만 한다.
// -> 암묵적으로 피연산자를 number로 변환 (단, +는 X)
console.log(10 - '3');
console.log(10 * '3');
console.log(10 / '3');
console.log(10 % '삼');
//-> 삼을 number로 변경할 수 없기 때문에 NaN 출력
...
// NaN은 어떠한 비교 연산자를 이용해도 비교 불가다!
console.log(`10 > 'a' : ${10 > 'a'}`);
console.log(`10 > 'a' : ${'b' > 'a'}`);
...
console.log(+{}); //NaN
console.log(+[]); //NaN    // 배열, 0( 빈 배열)
console.log(+[999]); // 배열 999 (0번 인덱스 값 출력)
console.log(+['a']); // 배열, NaN(0번 인덱스 값을 숫자로 변환
console.log(+[999, 888]); // 배열, NaN(여러 인덱스가 있어 무엇을 숫자로 변활할지 모름)
console.log(+function (){}); // NaN

/* 기억할 것
* 1) 빈문자열, 반배열, null, false -> 0
* 2) true -> 1

...
console.log("이름이 홍길동인 학생 찾기 :", students.find(item => item.name === "홍길동"));
console.log("이름이 홍길동인 학생 찾기 :", students.find(item => item.name === "이순신"));

console.log("이름이 홍길동인 학생 찾기 :", students.findIndex(item => item.name === "홍길동"));
console.log("이름이 홍길동인 학생 찾기 :", students.findIndex(item => item.name === "이순신"));


// 점수가 80점 이상인 학생 모두 찾기
